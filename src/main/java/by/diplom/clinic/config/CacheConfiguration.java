package by.diplom.clinic.config;
...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer() {
        return cm -> {
            createCache(cm, by.diplom.clinic.repository.UserRepository.USERS_BY_LOGIN_CACHE);
            createCache(cm, by.diplom.clinic.repository.UserRepository.USERS_BY_EMAIL_CACHE);
            createCache(cm, by.diplom.clinic.domain.User.class.getName());
